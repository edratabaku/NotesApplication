...
{
    public class NoteRepository<TEntity> : IRepository<TEntity> where TEntity : BaseEntity
    {
        #region Fields
        ...
        public NoteRepository(IDBContext context, ILogger<NoteRepository<TEntity>> logger)
        {
            _context = context;
            _logger = logger;
